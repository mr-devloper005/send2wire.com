...
export const editableRootStyle = {
  '--editable-container': '1088px',
  '--slot4-page-bg': '#eef4f7',
  '--slot4-page-text': '#0b1220',
  '--slot4-panel-bg': '#dfe9ef',
  '--slot4-surface-bg': '#fffdfa',
  '--slot4-muted-text': '#425466',
  '--slot4-soft-muted-text': '#65758b',
  '--slot4-accent': '#e11d48',
  '--slot4-accent-fill': '#e11d48',
  '--slot4-accent-soft': '#ffe3ea',
  '--slot4-dark-bg': '#07111f',
  '--slot4-dark-text': '#ffffff',
  '--slot4-media-bg': '#dbe7ef',
  '--slot4-cream': '#eef4f7',
  '--slot4-warm': '#fffdfa',
  '--slot4-lavender': '#0f766e',
  '--slot4-gray': '#e6edf2',
  '--slot4-body-gradient': 'linear-gradient(180deg, #eef4f7 0%, #fffdfa 52%, #e6edf2 100%)',
} as CSSProperties
...
export const editableDesignContract = {
  shell: {
    ...
    section: 'mx-auto w-full max-w-[1088px] px-4 sm:px-6 lg:px-8',
...
export const aiLayoutRules = [
  ...
  'Use a premium media-distribution visual system with balanced containers, strong text cards, trust signals, and restrained red/black accents.',
